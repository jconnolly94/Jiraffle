...
var Arrow = /*#__PURE__*/function (_Component) {
  ...
  return _createClass(Arrow, [{
    ...
    value: function transformArrowHead(head, isStart) {
      ...
      var position = glMatrix.vec3.fromValues(x2, y2, 0);
...
var Circle = ElementOf(g.Shape.CIRCLE);
var Ellipse = ElementOf(g.Shape.ELLIPSE);
var Group = ElementOf(g.Shape.GROUP);
var HTML = ElementOf(g.Shape.HTML);
var Image = ElementOf(g.Shape.IMAGE);
var Line = ElementOf(g.Shape.LINE);
var Path = ElementOf(g.Shape.PATH);
var Polygon = ElementOf(g.Shape.POLYGON);
var Polyline = ElementOf(g.Shape.POLYLINE);
var Rect = ElementOf(g.Shape.RECT);
var Text = ElementOf(g.Shape.TEXT);
...
var Canvas = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var innerCanvasRef = React.useRef(null);
